    ...
    modules: [
      {
        ...
        summary: 'Master the art of clear, empathetic communicationâ€”the foundation of all workplace relationships. Learn to express ideas concisely, listen actively, and handle difficult conversations with grace.',
        quiz: [
          {
      ...
      },
      {
        ...
        summary: "Great teams aren't built on talent aloneâ€”they're built on trust, respect, and shared purpose. Learn to collaborate across differences, support your teammates, and resolve conflicts constructively.",
        quiz: [
          {
      ...
      },
      {
        ...
        summary: "Productivity isn't about doing moreâ€”it's about doing what matters most with intention. Learn proven prioritization methods, build focused work habits, and maintain balance to avoid burnout.",
        quiz: [
          {
...

  {
    ...
    modules: [
      ...
      },
      {
        ...
        summary: 'Networking is not about collecting contactsâ€”it is about building genuine relationships. Learn to reach out authentically, add value to others, leverage LinkedIn, and maintain your network over time.',
        quiz: [
          {
        ...
        quiz: [
          {
            ...
            options: { a: 'In the very first interview', b: 'Only after you have received a written offer', c: 'Neverâ€”let the employer always go first', d: 'It does not matter when you bring it up' },
            correct: 'b'
          },
          {
          ...
          },
          {
            ...
            options: { a: 'Accept immediately to avoid seeming difficult', b: 'Politely counter with a justified ask based on your research', c: 'Reject the offer without discussion', d: 'Never negotiateâ€”it is rude' },
            correct: 'b'
          }
        ]
      },
      {
        ...
        summary: 'Your personal brand is your professional reputationâ€”and it exists whether you manage it or not. Learn to define your unique value proposition, optimize your digital presence, and consistently communicate your story.',
        quiz: [
          {
          ...
          },
          {
            ...
            options: { a: 'Waste time that could be spent on real work', b: 'Build credibility, attract opportunities, and grow your network', c: 'Only entertain people', d: 'Nothingâ€”content does not matter for careers' },
            correct: 'b'
          }
        ]
      },
      ...
      },
      {
        ...
        summary: 'Success does not happen by accident. Build a realistic 5-year career plan that aligns your values and strengths with market opportunitiesâ€”and learn to adapt it as you grow.',
        quiz: [
          {
      ...
      },
      {
        ...
        summary: 'Choosing the right opportunity is one of the most impactful career decisions you will make. Learn to evaluate offers across salary, growth, culture, and alignmentâ€”not just pay.',
        quiz: [
          {
      ...
      },
      {
        ...
        quiz: [
          ...
          },
          {
            ...
            options: { a: 'Neverâ€”they are too busy', b: 'Regularly, with prepared updates and specific questions', c: 'Only when things go wrong', d: 'Every hour to show commitment' },
            correct: 'b'
          }
        ]
      }
...

  {
    ...
    modules: [
      ...
      },
      {
        ...
        summary: 'AI can dramatically accelerate your writingâ€”from emails to reports to social media posts. Learn how to collaborate with AI to produce polished content faster, while maintaining your own voice and always reviewing for accuracy.',
        quiz: [
          {
      ...
      },
      {
        ...
        summary: 'AI is a powerful learning accelerator. Use it to explain complex topics, generate study materials, summarise long documents, and explore new fieldsâ€”while always verifying facts from primary sources.',
        quiz: [
          {
      ...
      },
      {
        ...
        summary: 'AI coding assistants have transformed software development. Learn how to use GitHub Copilot, ChatGPT, and similar tools to write, debug, and understand codeâ€”while maintaining the skills to review and improve AI outputs.',
        quiz: [
          {
          ...
          },
          {
            ...
            options: { a: 'AI makes code too efficient', b: 'You may not develop the fundamental skills to debug or extend the code', c: 'AI code runs too fast', d: 'There is no riskâ€”AI is perfect' },
            correct: 'b'
          }
        ]
      },
      {
        ...
        summary: 'Data is the new oilâ€”and AI makes it far more accessible. Learn to use AI tools to clean data, run analysis, generate visualisations, and extract meaningful insights without being an expert data scientist.',
        quiz: [
          {
          ...
          },
          {
            ...
            options: { a: 'Nothingâ€”AI charts are always accurate', b: 'Whether the data is accurate, the visualisation is appropriate, and labels are clear', c: 'Only the visual design', d: 'Only the colour scheme' },
            correct: 'b'
          }
        ]
      },
      {
        ...
        summary: 'AI is a creative co-pilot. Learn to use AI image generators, writing tools, and ideation assistants to accelerate your creative projectsâ€”while ensuring the final work reflects your vision and voice.',
        quiz: [
          {
      ...
      },
      {
        ...
        summary: 'With great power comes great responsibility. Understand the ethical dimensions of AIâ€”bias, privacy, misinformation, and accountabilityâ€”and develop habits for responsible, transparent AI use.',
        quiz: [
          {
      ...
      },
      {
        ...
        quiz: [
          ...
          },
          {
            ...
            options: { a: 'Use it on your most critical project immediately', b: 'Test it on low-stakes tasks first and evaluate output quality before relying on it', c: 'Trust the marketing claims entirely', d: 'Avoid new toolsâ€”stick to what you know' },
            correct: 'b'
          },
          {
      ...
      },
      {
        ...
        summary: 'AI is not taking jobsâ€”it is changing them. Learn which skills will remain irreplaceable, how to position yourself for the AI economy, and how to keep learning as the landscape evolves.',
        quiz: [
          {
