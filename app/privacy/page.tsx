...
export const metadata: Metadata = {
  ...
  description: 'How Wissen-Haus Youth Empowerment Foundation collects, uses, and protects your personal information.',
}
    ...
    <div style={{ background: '#fefcf5', minHeight: '100vh' }}>
      <div style={{ maxWidth: 820, margin: '0 auto', padding: 'clamp(32px,5vw,64px) clamp(20px,4vw,40px)' }}>
        ...
        <article style={{ color: '#1a2e24', lineHeight: 1.75, fontSize: '.96rem' }}>
          ...
          <p>
            Wissen-Haus Youth Empowerment Foundation is headquartered in Ibadan, Oyo State, Nigeria. We are the data controller for personal information collected through the Site. For any privacy-related question, contact us at <a href="mailto:info@wissenhaus.org" style={{ color: '#1a3c2e' }}>info@wissenhaus.org</a>.
          </p>
          ...
          <p>
            Questions about this Privacy Policy or your personal information can be sent to <a href="mailto:info@wissenhaus.org" style={{ color: '#1a3c2e' }}>info@wissenhaus.org</a>, or by post to Wissen-Haus Youth Empowerment Foundation, Ibadan, Oyo State, Nigeria.
          </p>
